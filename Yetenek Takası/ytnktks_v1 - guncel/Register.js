...
getFirestore(app); // Eğer Firestore kullanacaksan
getStorage(app);   // Eğer Storage kullanacaksan
...
document.getElementById("login").addEventListener("click", function (event) {
    ...
    signInWithEmailAndPassword(auth, email, password)
        .then((userCredential) => {
            ...
            window.location.href = "profil.html"; // URL'ye userId eklemene gerek yok
        })
        .catch((error) => {
